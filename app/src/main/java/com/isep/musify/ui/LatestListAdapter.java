...
public class LatestListAdapter extends RecyclerView.Adapter<LatestListAdapter.MyViewHolder> {

    private List<Item> dataList;
    private static LatestListAdapter.GalleryClickListener itemClickListener;
    ...
    public LatestListAdapter(List<Item> myDataset) {
        dataList = myDataset;
    }

    @Override
    public LatestListAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(LatestListAdapter.MyViewHolder holder, int position) {
